  ...
  async pool() {
    try {
      await Helper.delay(
        1000,
        this.acc,
        `Adding TON/AYTU_USDT/aUSDT Poll ...`,
        this
      );
      const seqno = await this.walletContract.getSeqno();

      const rawData1 =
        "";
      const rawData2 =
        "";
      const rawData3 =
        "";
      const bodyCell1 = Cell.fromBoc(Buffer.from(rawData1, "hex"))[0];
      const bodyCell2 = Cell.fromBoc(Buffer.from(rawData2, "hex"))[0];
      const bodyCell3 = Cell.fromBoc(Buffer.from(rawData3, "hex"))[0];

      const inMsg1 = internal({
        to: ContractEnums.SWAPCONTRACT,
        value: "0.3",
        bounce: true,
        body: bodyCell1,
      });
      const inMsg2 = internal({
        to: ContractEnums.SWAPCONTRACT,
        value: "0.3",
        bounce: true,
        body: bodyCell2,
      });
      const inMsg3 = internal({
        to: ContractEnums.SWAPCONTRACT,
        value: "0.3",
        bounce: true,
        body: bodyCell3,
      ...
      const tx = await this.walletContract.sendTransfer({
        seqno: seqno,
        secretKey: this.keyPair.secretKey,
        messages: [inMsg1, inMsg2, inMsg3],
      });
      await this.confirmTx(tx, seqno);
      await Helper.delay(
        3000,
        this.acc,
        `Adding TON/AYTU_USDT/aUSDT Poll TX Complete, Tx Confirmed ...`,
        this
      );
    } catch (error) {
      console.log(error);
